...
#save(sims_b,sims_d,sneq_b,sneq_d,file=paste0("sims_errortest_betapsi_s",s,"_f1_0.RData"))
save(sims_d,sneq_d,file=paste0("sims_errortest_psi005_s",s,".RData"))