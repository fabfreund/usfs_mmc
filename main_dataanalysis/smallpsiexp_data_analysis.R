...
system("rm temp*")
system(paste0("mv phi.table.",name1," phi_tables_smallpsi/"))
}
...
system(paste0("mv tempsfs-Lump*Grid.txt likelihood_grids_smallpsi/grid_",name1))
system(paste0("mv tempsfs-Lump*MLEstimates.txt ML_est_smallpsi/ML_",name1))
