...
phi_tab_alpha <- read.delim(paste0("../main_dataanalysis/",
                                   "phi_tables_beta/phi.table.",
                                   sfs_name), 
                            header=FALSE)
...
phi_tab_psi <- read.delim(paste0("../main_dataanalysis/",
                                 "phi_tables_smallpsi/phi.table.",
                                 sfs_name), 
                          header=FALSE)
